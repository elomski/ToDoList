package com.example.todolistbrief.ui.views.screens.authentication
...
import com.example.todolistbrief.R
import com.example.todolistbrief.data.room.models.User
import com.example.todolistbrief.ui.components.DefaultCheckbox
import com.example.todolistbrief.ui.components.DefaultTextField
import com.example.todolistbrief.ui.theme.TodolistbriefTheme
import com.example.todolistbrief.ui.views.AuthRouteScreens
import com.example.todolistbrief.ui.views.layout.BackTopAppBar
import com.example.todolistbrief.utils.StringConstants
import com.example.todolistbrief.utils.emailLengthValidation
import com.example.todolistbrief.utils.fullNameLengthValidation
import com.example.todolistbrief.utils.passwordLengthValidation
import com.example.todolistbrief.viewmodels.AuthViewModel
                                ...
                                if (!isTermsAccepted) {
                                    ...
                                    if (authState.usersList.isNotEmpty()) {
                                        ...
                                        authViewModel.sendOTPCode(
                                            com.example.todolistbrief.data.room.models.OTPCode(
                                                email = email,
